 ...
 *
 */
public class SentenceParsedInformation {
	private ArrayList<String> original_tokens;
	private ArrayList<String> words_and_tags;
	private String constitute_tree;
	private ArrayList<String> dependency_tree;

	public SentenceParsedInformation(ArrayList<String> original_tokens, ArrayList<String> words_and_tags, String constitute_tree, ArrayList<String> dependency_tree){
	...
	public ArrayList<String> getDependency_tree() {
		return dependency_tree;
	}

	public void setDependency_tree(ArrayList<String> dependency_tree) {
		this.dependency_tree = dependency_tree;
	}
	...
	public String toString(){
		...
		for (String dRelation : dependency_tree) {
			result.append(dRelation + "\n");
		}
		result.append("\n");
